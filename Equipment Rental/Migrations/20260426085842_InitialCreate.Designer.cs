...
namespace Equipment_Rental.Migrations
{
    ...
    [Migration("20260426085842_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Equipment_Rental.Models.EquipmentItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Equipment_Rental.Models.RentalRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Equipment_Rental.Models.RentalRequestItem", b =>
                {
            ...
            modelBuilder.Entity("Equipment_Rental.Models.RentalRequestItem", b =>
                {
                    b.HasOne("Equipment_Rental.Models.EquipmentItem", "EquipmentItem")
                        .WithMany("RentalItems")
                        .HasForeignKey("EquipmentItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Equipment_Rental.Models.RentalRequest", "RentalRequest")
                        .WithMany("Items")
